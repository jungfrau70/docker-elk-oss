...
A few extensions are available inside the [`extensions`](extensions-xxxxx) directory. These extensions provide features which
...
[config-es]: services/elasticsearch/config/elasticsearch.yml
[config-kbn]: services/kibana/config/kibana.yml
[config-ls]: services/logstash/config/logstash.yml
